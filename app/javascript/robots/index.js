...
import RobotsDemo from './components/RobotsDemo.vue'
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   */
  if ( document.getElementById('robots-demo-page') ) {
    ...
    * Vue app if we actually find it */
    new Vue({
      ...
      render (h) { return h(RobotsDemo, { props: { ...this.$el.dataset, programs: Programs } }) }
    }).$mount('#robots-demo-page')
  }
})
